...
### Этап 1 — Документы и доступы

Подписание документов (HR-верификация), получение доступов, MPulse и база знаний Confluence.

| Шаг | Задача | XP |
| --- | ------ | -- |
| 1 | Подписание документов (5 видов, HR) | 5 |
| 2 | Доступы: MBusiness, бухгалтер, Wi-Fi, пропуск, Telegram | 0 |
| 3 | MPulse: установка, график, check-in/out, код | 5 |
| 4 | Confluence: 5 страниц + «Я ознакомился» | 10 |

**Бонус за этап:** 150 XP · **Итого задачи:** 20 XP
