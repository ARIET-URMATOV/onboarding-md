...
STAGES = [
    (1, "Документы и доступы", "Документы", "Подписание документов, получение доступов, настройка MPulse и изучение базы знаний Confluence.", 150, "Ачивка «Старт»", "Откроется после прохождения этапа", "docs", 1),
