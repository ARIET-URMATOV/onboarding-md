  ...
  return (
    <div className="role-wrap">
      <div className="role-head">
        <div className="pill">ШАГ 0 / 1</div>
        <h1 className="font-orbitron">Выбери свою роль</h1>
        <p>Это поможет нам настроить твой путь онбординга. Потом можно изменить.</p>
      </div>
      ...
      <div className="role-grid">
        {ROLES.map((r) => (
          ...
          >
            ...
            <div className="role-go">ВЫБРАТЬ →</div>
          </button>
        ))}
      </div>
